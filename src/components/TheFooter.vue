<template>
  <footer class="overflow-hidden">
    <div class="container space-y-14 relative">
      <img
        src="/assets/img/footer-decor-1.png"
        alt="Footer"
        class="absolute bottom-24 -left-10"
      />
      <img
        src="/assets/img/footer-decor-2.png"
        alt="Footer"
      ...
      <div class="pb-32 relative">
        ...
        <img
          ...
          alt="Footer"
          class="absolute bottom-10 left-56"
        />
        <img
          src="/assets/img/footer-decor-4.png"
          alt="Footer"
          class="absolute bottom-2 right-56"
        />
      </div>
      <div class="flex flex-wrap justify-between gap-10">
        <div class="space-y-10">
          ...
          <ul class="flex items-center gap-2">
            <li class="leading-0">
              <a
                href="#"
                class="inline-block text-deep-blue-500 p-3 rounded-full border-1 border-deep-blue-500 box-border"
              >
                <svg
                  width="24"
                  height="24"
                ...
                >
                  <path
                    d="M13.397 20.9972V12.8011H16.162L16.573 9.59215H13.397V7.54815C13.397 6.62215 13.655 5.98815 14.984 5.98815H16.668V3.12715C15.849 3.03915 15.025 2.99715 14.201 3.00015C11.757 3.00015 10.079 4.49215 10.079 7.23115V9.58615H7.33203V12.7951H10.085V20.9972H13.397Z"
                    fill="#3B4EFF"
                  />
                </svg>
              </a>
        ...
        <div v-for="section in footer" :key="section.id" class="space-y-10">
          <h5 class="uppercase font-medium text-xl">{{ section.title }}</h5>
          <ul class="space-y-4">
            <li v-for="(link, i) in section.links" :key="i">
              <a
                href="#"
                :class="[
                  { 'text-deep-blue-500': link === active },
      ...
      <div class="py-6 border-t border-dark-gray">
        <div class="flex justify-between">
          <p class="opacity-80">© 2021. All Right Reserved</p>
          <ul class="flex gap-6">
            <li>
              <a href="#">Career</a>
            </li>
  ...
  data: () => ({
    ...
    footer: [
      ...
      },
      {
        id: 1,
        title: "Features",
        links: ["Claims", "API", "Giveback", "Renters"],
      },
      {
        id: 2,
        title: "Company",
        links: ["Join the Team", "Legal Stuff", "Accessibility", "Reviews"],
      },
      {
        id: 3,
        title: "Resource",
        links: ["Blog", "Transparency", "Investor Relations", "Community"],
      },
    ],
  }),
};
